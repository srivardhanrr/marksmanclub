...
<header
	class="bg-white text-dark shadow-lg z-50 sticky top-0 w-full overflow-hidden"
>
		...
		<nav class="flex items-center justify-between">
			...
			<a href="/" class="flex items-center">
				<img
					...
					alt="The Marksman Shooting Academy Logo"
			...
			<ul class="hidden lg:flex items-center gap-8">
				...
				<li>
					<a
						href="https://wa.me/917877393777?text=Hi,%20I'd%20like%20to%20know%20more."
						target="_blank"
...
<footer class="bg-dark text-white py-12 w-full overflow-hidden">
	<div class="container">
		<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
			...
			<div>
				<h3 class="text-xl font-bold mb-4 text-primary">
					The Marksman Shooting Academy
				</h3>
				<p class="mb-4 text-tertiary">
					Begin your Shooting journey with us Today.
				</p>
		...
		<!-- Copyright -->
		<div
			class="border-t border-gray-700 mt-8 pt-8 text-center text-tertiary"
		>
			<p>
				&copy; {new Date().getFullYear()} The Marksman Shooting Academy |
				All Rights Reserved
			</p>
		</div>
	</div>
